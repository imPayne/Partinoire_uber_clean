...
class MenagePartyController extends AbstractController
{
    ...
    public function index(HouseworkRepository $houseworkRepository, SessionInterface $session, Request $request, EntityManagerInterface $entityManager): Response
    {
